...
//
//    private final Map<String, BlockingQueue<PullUpdateFuture>> pullUpdateQueues = new HashMap<>();
...
//    {
//        BlockingQueue<PullUpdateFuture> queue = pullUpdateQueues.get( slave.getHostnamePort().toString() );
//        if ( queue == null )
//        {
//            // Create queue and worker
//            queue = new ArrayBlockingQueue<>( PULL_UPDATES_QUEUE_SIZE );
//            pullUpdateQueues.put( slave.getHostnamePort().toString(), queue );
//
