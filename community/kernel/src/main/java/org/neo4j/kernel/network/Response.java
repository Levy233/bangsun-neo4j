...
import org.neo4j.kernel.network.exception.ServerFailureException;
...
/**
 * In response to a {@link ClientForData#sendRequest(RequestContext, Serializer, Deserializer) request}
