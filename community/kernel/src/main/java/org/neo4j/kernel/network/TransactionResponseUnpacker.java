...
// */
//public class TransactionResponseUnpacker extends LifecycleAdapter {
...
//
//    public TransactionResponseUnpacker(Dependencies dependencies, long idReuseSafeZoneTime) {
...
//        this.batchCommitter = new TransactionBatchCommitter(kernelTransactions, idReuseSafeZoneTime, commitProcess, log.getInternalLog(TransactionResponseUnpacker.class));
