...
{
    public static final byte CONTINUATION_LAST = 0;
    public static final byte CONTINUATION_MORE = 1;
    public static final byte OUTCOME_SUCCESS = 0;
    public static final byte OUTCOME_FAILURE = 1;
